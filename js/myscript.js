...
function showCLFields() {
    ...
    document.getElementById("liabilitiesCurrent").appendChild(node).style.textAlign = "right";
...
function showIPEFields() {
    ...
    document.getElementById("investments").appendChild(node).style.textAlign = "right";
...
function showLTLFields() {
    ...
    document.getElementById("liabilitiesLongTerm").appendChild(node).style.textAlign = "right";
...
function showIntFields() {
    ...
    document.getElementById("intangibles").appendChild(node).style.textAlign = "right";

    document.getElementById("buttonInt").style.display = "none";
}

// calcuating total position
function calculatePosition() {
    ...
    totCurrentAssets.innerHTML = "Total Current Assets: $"+TCA.toFixed(2);
    console.log(TCA);       
    ...
    totCurrentLiab.innerHTML = "Total Current Liabilities: $"+TCL.toFixed(2);
    console.log(TCL);
    ...
    totInvProp.innerHTML = "Total Investment Property and Equipment: $"+TIPE.toFixed(2);
    console.log(TIPE);
    ...
    totLongTermLiab.innerHTML = "Total Long-Term Liabilities: $"+TLTL.toFixed(2);
    console.log(TLTL);
    ...
    totIntangibles.innerHTML = "Total Intangibles: $"+TI.toFixed(2);
    console.log(TI); 

    document.getElementById("totalAssets").innerHTML = "Total Assets: $"+(TCA+TIPE+TI).toFixed(2);
    document.getElementById("totalLiab").innerHTML = "Total Liabilities: $"+(TCL+TLTL).toFixed(2);
    document.getElementById("position").innerHTML = "Position: $"+((TCA+TIPE+TI)-(TCL+TLTL)).toFixed(2);
}